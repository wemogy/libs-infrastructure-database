...
{
    /// <summary>
    ///     Retrieve a single entity from the repository by its unique identifier and partition key.
    /// </summary>
    ...
    /// <summary>
    ///     Retrieve a single entity from the repository by its unique identifier.
