...
public interface IPatchOperations<TEntity>
{
    ...
    ///     not carry yet starts at zero.
    ///     <para>
    ///         There is no <c>decimal</c> overload on purpose: Cosmos DB increments a field as a
    ///         64-bit integer or as a double, and narrowing a decimal to a double would silently
    ///         lose precision on values that are usually money.
    ///     </para>
    /// </summary>
