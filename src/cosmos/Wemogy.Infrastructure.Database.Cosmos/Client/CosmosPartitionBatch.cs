...
namespace Wemogy.Infrastructure.Database.Cosmos.Client
{
    ...
    public class CosmosPartitionBatch : DatabasePartitionBatchBase
    {
        ...
        ///     shape of the document even though the batch mixes types.
        /// </summary>
        ...
        private void RecordOperation<T>(string id)
        {
            ...
            _operationTypeNames.Add(typeof(T).Name);
        }
        ...
        ///     the operation is not a patch or was unconditional. Whether the operation is a patch at
        ///     all is a separate question, answered by the presence of the key.
        /// </summary>
